...
x = tf.placeholder(tf.float32, shape=(None, 2))     #shape中不确定喂多少组写none，体积和重量两个特征则是2
y_= tf.placeholder(tf.float32, shape=(None, 1))     #shape中不确定输出多少组写none，只有一个标记，合格或不合格

w1= tf.Variable(tf.random_normal([2, 3], stddev=1, seed=1))    #隐藏层用三个神经元
